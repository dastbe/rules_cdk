...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@contrib_rules_cdk//cdk:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.cdkinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@contrib_rules_cdk//cdk:toolchain_type"],
...
# By default all these toolchains are registered by the cdk_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:cdk_toolchain",
    toolchain_type = "@contrib_rules_cdk//cdk:toolchain_type",
)
""".format(
            platform = platform,
