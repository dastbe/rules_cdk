...
require github.com/aws/aws-cdk-go/awscdk/v2 v2.67.0

require (
	github.com/Masterminds/semver/v3 v3.2.0 // indirect
	github.com/aws/constructs-go/constructs/v10 v10.1.264 // indirect
	github.com/aws/jsii-runtime-go v1.76.0 // indirect
